...
class TrainOptions():
  def __init__(self):
    ...
    # data loader related
    self.parser.add_argument('--dataroot', type=str, default='/data1/dataset/bdd100k', help='path of data')
    self.parser.add_argument('--phase', type=str, default='train', help='setup subset for dataloading (bdd100k, alps does split dataset!)')
...
class TestOptions():
  def __init__(self):
    ...
    # data loader related
    self.parser.add_argument('--dataroot', type=str, default='/data1/dataset/WeatherGAN', help='path of data')
