...
from dataset import dataset_single, wea_dataset_single
...
def main():
  ...
  print('\n--- load dataset ---')
  if opts.a2b:
    dataset = wea_dataset_single(opts, 'cloudy', opts.input_dim_a)
  else:
    dataset = wea_dataset_single(opts, 'sunny', opts.input_dim_b)
